    ...
    public partial class CreationBDD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipeLicensie", x => new { x.EquipesID, x.LicensiesID });
                    table.ForeignKey(
                        name: "FK_EquipeLicensie_Equipe_EquipesID",
                        column: x => x.EquipesID,
                        principalTable: "Equipe",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipeLicensie_Licensie_LicensiesID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipeLicensie_LicensiesID",
                table: "EquipeLicensie",
                column: "LicensiesID");
